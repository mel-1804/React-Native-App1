  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        style={{width: 200, height: 200, backgroundColor: 'blue', borderRadius: 100, justifyContent: 'center', alignItems: 'center'}}>
        <Text style={{color: 'white'}}>Pulsa aquí</Text>  
      </TouchableOpacity>
      ...
      <Pressable
        ...
        style={({ pressed }) => [
          ...
          {({pressed}) => (
            <Text style={
              {fontSize: pressed? 32 : 16,}}>{pressed ? 'Pressed!' : 'Press Me'}</Text>
          )}
          </Pressable>
